...
for arquivo in arquivos('*.txt'):
    if arquivo == 'meninos.txt':
        linhas[0] = lerLinhas(arquivo)
    if arquivo == 'meninas.txt':
        linhas[1] = lerLinhas(arquivo)

#Código para separar os subconjuntos
#subconjunto de testes
sub_testes['meninos'] = linhas[0]
sub_testes['meninos'] = sub_testes['meninos'][:len(sub_testes['meninos'])//8]

sub_testes['meninas'] = linhas[1]
sub_testes['meninas'] = sub_testes['meninas'][:len(sub_testes['meninas'])//8]

#subconjunto de treino
#separa o array de nomes de meninos em um array que utiliza a oitava parte final do array completo
#tanto para meninos quanto para meninas
sub_treinamento['meninos'] = linhas[0]
sub_treinamento['meninos'] = sub_treinamento['meninos'][len(sub_treinamento['meninos'])//2:]
sub_treinamento['meninos'] = sub_treinamento['meninos'][len(sub_treinamento['meninos'])//2:]
sub_treinamento['meninos'] = sub_treinamento['meninos'][len(sub_treinamento['meninos'])//2:]
sub_treinamento['meninos'] = sub_treinamento['meninos'][len(sub_treinamento['meninos'])//2:]

sub_treinamento['meninas'] = linhas[1]
sub_treinamento['meninas'] = sub_treinamento['meninas'][len(sub_treinamento['meninas'])//2:]
sub_treinamento['meninas'] = sub_treinamento['meninas'][len(sub_treinamento['meninas'])//2:]
sub_treinamento['meninas'] = sub_treinamento['meninas'][len(sub_treinamento['meninas'])//2:]
sub_treinamento['meninas'] = sub_treinamento['meninas'][len(sub_treinamento['meninas'])//2:]
...
def randomTrainingExample():
    ...
    line = randomChoice(sub_treinamento[category])
